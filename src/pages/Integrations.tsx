...
const allIntegrations: IntegrationMeta[] = [
  { type: 'messenger', name: 'Facebook Messenger', description: 'استقبل رسائل صفحتك على فيسبوك في صندوق سكة', icon: <Facebook className="h-6 w-6" />, color: 'text-[#0084FF]', bg: 'bg-[#0084FF]/10', category: 'messaging', featured: true },
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-body opacity-90">اربط سكة بالأدوات والمنصات التي تستخدمها يومياً</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
  ...
  return (
    ...
    >
      ...
      {integration?.connected ? (
        ...
        <div className="space-y-3">
          <p className="text-small font-semibold">سيتم منح سكة الصلاحيات التالية:</p>
