...
const actionMeta: Record<ActivityAction, { label: string; icon: React.ElementType; color: string }> = {
  ...
  client_email_changed: { label: 'تغيير البريد', icon: UserCheck, color: 'text-blue-500 bg-blue-500/10' },
  client_password_changed: { label: 'تغيير كلمة المرور', icon: Shield, color: 'text-amber-500 bg-amber-500/10' },
  ...
  subscription_cancel_scheduled: { label: 'جدولة إلغاء الاشتراك', icon: XCircle, color: 'text-amber-500 bg-amber-500/10' },
  subscription_upgraded: { label: 'ترقية الاشتراك', icon: Package, color: 'text-emerald-500 bg-emerald-500/10' },
  invoice_refunded: { label: 'استرداد فاتورة', icon: RefreshCcw, color: 'text-amber-500 bg-amber-500/10' },
  invoice_resent: { label: 'إعادة إرسال فاتورة', icon: CreditCard, color: 'text-blue-500 bg-blue-500/10' },
  payment_received: { label: 'دفعة مستلمة', icon: CreditCard, color: 'text-emerald-500 bg-emerald-500/10' },
  employee_registered: { label: 'تسجيل موظف', icon: UserPlus, color: 'text-emerald-500 bg-emerald-500/10' },
  channel_connected: { label: 'ربط قناة', icon: Activity, color: 'text-emerald-500 bg-emerald-500/10' },
  channel_disconnected: { label: 'فصل قناة', icon: Activity, color: 'text-red-500 bg-red-500/10' },
  complaint_submitted: { label: 'شكوى مقدمة', icon: AlertTriangle, color: 'text-amber-500 bg-amber-500/10' },
  support_replied: { label: 'رد الدعم', icon: MessageSquare, color: 'text-blue-500 bg-blue-500/10' },
