...
export const integrations: Integration[] = [
  { id: 'i1', type: 'messenger', name: 'Facebook Messenger', description: 'استقبل رسائل صفحتك على فيسبوك', connected: true, accountName: 'qhub.oman', lastSync: nowMinus(5) },
  { id: 'i2', type: 'instagram', name: 'Instagram Direct', description: 'استقبل رسائل انستجرام المباشرة', connected: true, accountName: '@qhub_oman', lastSync: nowMinus(12) },
