...
export const plans: Plan[] = [
  {
    ...
    limits: { agents: 2, channels: 1, conversations: 100 },
  ...
  },
  {
    ...
    limits: { agents: 3, channels: 1, accountsPerChannel: 1, conversations: 1000 },
  ...
  },
  {
    ...
    limits: { agents: 10, channels: 3, accountsPerChannel: 2, conversations: 10000 },
  ...
  },
  {
    ...
    limits: { agents: 25, channels: 10, accountsPerChannel: 5, conversations: 50000 },
  ...
  },
  {
    ...
    limits: { agents: -1, channels: -1, conversations: -1 },
...
export type FeedbackStatus = 'awaiting_reply' | 'replied';
