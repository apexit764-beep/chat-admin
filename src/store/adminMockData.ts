...
export const plans: Plan[] = [
  ...
  },
  {
    ...
    limits: {
      agents: 3,
      channels: 1,
      perChannel: { whatsapp: 1, messenger: 1, instagram: 0, telegram: 0, widget: 1, email: 1 },
      conversations: 1000,
      contacts: 500,
    },
  ...
  },
  {
    ...
    limits: {
      agents: 10,
      channels: 3,
      perChannel: { whatsapp: 2, messenger: 2, instagram: 1, telegram: 1, widget: 1, email: 2 },
      conversations: 10000,
      contacts: -1,
    },
  ...
  },
  {
    ...
    limits: {
      agents: 25,
      channels: 10,
      perChannel: { whatsapp: 5, messenger: 3, instagram: 3, telegram: 3, widget: 2, email: 5 },
      conversations: 50000,
      contacts: -1,
    },
