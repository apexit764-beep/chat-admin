import{ay as h}from"./index-C4tFFbYy.js";/**
...
<body>${e}</body></html>`),n.document.close(),n.onload=()=>{setTimeout(()=>{n.focus(),n.print()},250)})}function u(t){return t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}export{g as D,b as d,f as p};
